...
export abstract class ChannelBase {
     ...
     *
     * In the case of `desktop` channels (see {@link SystemChannel}), these IDs _should_ persist across sessions. The
 ...
 */
export async function getDesktopChannels(): Promise<SystemChannel[]> {
    ...
    if (!channel) {
        switch (channelTransport.type) {
            case 'default':
                ...
                break;
            case 'desktop':
                channel = new SystemChannel(channelTransport as DesktopChannelTransport);
