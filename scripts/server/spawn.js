...
function createCustomManifestMiddleware() {
    return async (req, res, next) => {
        ...
        const {uuid, url, frame, defaultCentered, defaultLeft, defaultTop, defaultWidth, defaultHeight, realmName, enableMesh, runtime, useService, provider, config, licenseKey} = {
            // Set default values
