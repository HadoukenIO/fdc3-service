import 'jest';
import {MetadataStore, IAppMetadata} from '../../src/provider/MetadataStore';
...
describe('Given an empty MetadataStore', () => {
    ...
    describe('When calling update with valid data', () => {
        ...
        const expectedMetadata:IAppMetadata = {directoryId: appData.id, uuid: app.identity.uuid, name: app.identity.name!};
