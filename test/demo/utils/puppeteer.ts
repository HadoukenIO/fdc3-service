...
export class OFPuppeteerBrowser {
    ...
    public async getPage(identity:Identity): Promise<Page|undefined> {
        ...
        // Connect will always result in browser being defined, but typescript doesn't know that.
    ...
    public async executeOnWindow<T extends any[], R, C extends TestWindowContext = TestWindowContext>(executionTarget: Identity, fn: (this: C, ...args: T) => R, ...args: T): Promise<R> {
