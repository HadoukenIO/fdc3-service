...
import {ChannelEvents, getServiceIdentity} from '../../src/client/internal';
...
const directoryDisconnectTestParams: DisconnectTestParam[] = [
    ...
    ['navigated away with preregistered listeners', testAppWithPreregisteredListeners1, RegistrationStatus.REGISTERED, openDirectoryApp, async (app) => {
        await navigateTo(app, 'about:blank');
    }],
